          ...
          <div className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
            <div className="flex-auto p-6">
              <div className="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                ...
                >
                  <span className="flex-shrink-0 text-3xl font-black text-purple-800 lowercase tracking-tight opacity-100">
                    Shoppers
                  </span>
                </a>
              </div>
              ...
              <p className="mb-6 text-gray-500">
                Please sign-in to access your seller account
              </p>
              ...
              <form id="" className="mb-4" action="#" method="POST">
                ...
                <div className="mb-4">
                  <button
                    className="grid w-full cursor-pointer select-none rounded-md border bg-purple-700 hover:bg-purple-800 py-2 px-5 text-center align-middle text-sm text-white shadow hover:border-indigo-600 hover:bg-indigo-600 hover:text-white focus:border-indigo-600 focus:bg-indigo-600 focus:text-white focus:shadow-none"
                    type="submit"
                  >
                    Sign in
                  </button>
              ...
              <p className="mb-4 text-center">
                New Seller?
                <Link href="/shops/register"> Create an account </Link>
              </p>
            </div>
          </div>
        </div>
