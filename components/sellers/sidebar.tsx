  ...
  return (
    <div>
      <div className="min-h-screen bg-gray-50">
        <div className=" left-0 flex h-screen w-72 flex-col overflow-hidden rounded-r-2xl bg-purple-800 text-white">
          <h1 className="mt-10 ml-10 text-3xl text-white font-bold">
            Shoppers
          </h1>
          <ul className="mt-20 space-y-3">
            ...
            <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 hover:bg-slate-600">
              ...
              <Link href="/shops/upload">
                <span className="">Upload Products</span>
              </Link>
            </li>
            <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 hover:bg-slate-600">
              <span>
